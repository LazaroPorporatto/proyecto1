...
import { SeedFamiliaProductoModule } from './modules/common/seed/seed-familia-producto/seed-familia-producto.module';
...
@Module({
  imports: [
    ...
    TypeOrmModule.forRoot({
      ...
      port: parseInt(process.env.DB_PORT || '3310', 10), // Si PORT es undefined, usa 3306
      username: process.env.DB_USERNAME || 'admin', //"admin", //

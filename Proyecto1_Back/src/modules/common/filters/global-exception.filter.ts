...
export class GlobalExceptionFilter implements ExceptionFilter {
  private readonly logger = new Logger(GlobalExceptionFilter.name);
    ...
    // Mensaje real para el cliente: si es una HttpException,
    // getResponse() trae el detalle real (string o array de class-validator).
    // exception.message para esos casos es solo el texto genérico ("Bad Request Exception").
    const message =
      exceptionResponse &&
